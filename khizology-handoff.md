...
typed, reusable foundation for **Infooo — Interactive Knowledge Worlds**. World 001
(**Human Atlas**) is the only current public Infooo world. Future worlds are added
only when a real idea passes Truth, accessibility, performance, and Value Laws
review; Infooo does not grow by filling slots. `docs/INFOOO-IDENTITY.md` is the
product contract.
