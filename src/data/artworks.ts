...
const artworkTitleOverrides: Record<string, string> = {
  ...
  'just-a-chair-2026.jpg': 'Just a Chair',
...
const rawFiles: Array<{ filename: string; tags: string[] }> = [
  ...
  { filename: 'just-a-chair-2026.jpg', tags: ['concept', 'minimalism', 'vintage'] },
